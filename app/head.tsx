...
export default function Head() {
  return (
    <>
      ...
      <meta
        name="keywords"
        content="software developer, programmer, coding, react, javascript, typescript, nextjs, redux, nodejs, express, flutter, dart, mongodb, mern stack."
      />
      ...
      <meta
        ...
        content="Juan Segundo Chavero | Software Developer"
      />
